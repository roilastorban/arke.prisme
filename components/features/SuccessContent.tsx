...
export function SuccessContent({ title, method }: SuccessContentProps) {
  return (
        ...
        <div className="max-w-3xl mx-auto space-y-12">
          ...
          <div className="space-y-6">
            ...
            <p className="text-lg md:text-xl opacity-80 leading-relaxed">
              Le paiement par {method} a été validé avec succès. La Sentinelle Arké a reçu votre protocole et nos ingénieurs procèdent actuellement à l'analyse préliminaire de votre capital-marque.
            </p>
          </div>
          <div className="p-8 border-2 border-[#1F3D2B] bg-white shadow-[10px_10px_0px_#1F3D2B] space-y-6">
            <h2 className="text-xl font-black uppercase tracking-widest">Prochaine Étape</h2>
            <p className="text-sm md:text-base opacity-70">
              Un membre du collectif ^Prisme vous contactera par email sous <span className="font-black text-[#1F3D2B]">24 heures</span> pour initier la phase de calibration.
            </p>
          </div>
          <div className="pt-8">
            <Link href="/">
